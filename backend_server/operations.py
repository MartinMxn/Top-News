...
import common.mongodb_client as mongodb_client#pylint: disable=import-error, wrong-import-position
...
"""
get list from db, based on page num return the response
"""
